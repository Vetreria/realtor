...
class Claim(models.Model):
    ...
    flat = models.ForeignKey(Flat, verbose_name='Претензия по квартире:', related_name="flat", on_delete=models.CASCADE)
...
class Owner(models.Model):
    ...
    owned_flats = models.ManyToManyField(Flat, verbose_name='Квартиры в собственности', related_name='flat_owners',
                                         blank=True)
    def __str__(self):
        return self.name